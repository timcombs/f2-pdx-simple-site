...
// 2. Instead of returning a random value for Lectures and Labs, you could return the entire Lectures array or Labs array, create an unordered list with all the topic names, and insert that into the show­lectures or show­labs div.

// no need for "object" conditional
// think generically, similar data, similar process to add to html
// 2 buttons, 2 options - click:
//      - selectes either lectures or labs
//      - builds a title to go before the button heading
//      - takes json data and transforms to html
          // probably through .each() iteration
//      - places this schedule after the button heading
// need to remove old title and old schedule each time button clicked
